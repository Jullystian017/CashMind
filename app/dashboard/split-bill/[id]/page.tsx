            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <div className="flex items-center gap-3 mb-1">
                        <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 tracking-tight">{bill.title}</h2>
                        <span className={cn(
                ...
                <div className="divide-y divide-gray-50">
                    ...
                    {bill.participants.map((p) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                <span className={cn("text-sm font-semibold", p.is_paid ? "text-gray-400" : "text-gray-900")}>
                                    {formatRp(p.amount)}
                                </span>
                                {togglingId === p.id ? (
