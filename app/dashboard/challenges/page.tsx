...
export default function ChallengesPage() {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8 bg-gray-50 min-h-screen font-sans">
      {/* Header Section */}
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Financial Challenges</h1>
        <p className="text-slate-500">Level up your financial habits with fun challenges.</p>
      </div>
